...
public abstract class mages extends abClass {
        public int manna;

    public mages(int speed, int damage, int hp, int manna, String name,int x, int y) {
    ...
    public String getStat(){
        return "damage: "+damage+" speed: "+speed+" hp: "+hp+" manna: "+manna+" Class:";
    }
}
